...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registerButton.setForeground(new java.awt.Color(255, 57, 96));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(registerButton, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(24, 24, 24)
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        try {
            ...
            String query = "select * from Pembeli where Username_Pembeli = '"+usernameText.getText()+"'and Password_Pembeli = '"+passwordText.getText()+"'";
            rs = state.executeQuery(query);
            
            if(rs.next()){
                if (usernameText.getText().equals(rs.getString("Username_Pembeli")) && passwordText.getText().equals(rs.getString("Password_Pembeli"))){
