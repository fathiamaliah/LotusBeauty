...
public class DataPesanan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        keranjangText = new javax.swing.JTextField();
        ...
        ongkosText = new javax.swing.JTextField();
        ...
        tabelData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pesanan", "ID Keranjang", "ID Admin", "Nama Toko", "Waktu Pemesanan", "Total Harga", "Ongkos Kirim", "Status Pemesanan"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Object.class
            };
        ...
        jLabel2.setText("ID Keranjang");

        keranjangText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                keranjangTextActionPerformed(evt);
            }
        });
        ...
        ongkosText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ongkosTextActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(keranjangText, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(ongkosText, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(26, 26, 26)
                        .addComponent(ongkosText, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel2)
                                    .addComponent(keranjangText, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void firstButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_firstButtonActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("select * from Pesanan where ID_Pesanan='"+klik+"'");
            if(sql.next()){
                String ID_Pesanan = sql.getString("ID_Pesanan");
                pesananText.setText(ID_Pesanan);
                String Keranjang_ID_Keranjang = sql.getString("Keranjang_ID_Keranjang");
                keranjangText.setText(Keranjang_ID_Keranjang);
                String Karyawan_Admin_ID_Admin = sql.getString("Karyawan_Admin_ID_Admin");
                adminText.setText(Karyawan_Admin_ID_Admin);
                String Waktu_Pemesanan= sql.getString("Waktu_Pemesanan");
                waktuText.setText(Waktu_Pemesanan);
                String Total_Harga = sql.getString("Total_Harga");
                totalText.setText(Total_Harga);
                String Ongkos_Kirim = sql.getString("Ongkos_Kirim");
                ongkosText.setText(Ongkos_Kirim);
                String Status_Pemesanan = sql.getString("Status_Pemesanan");
                statusText.setText(Status_Pemesanan);
            }
        } catch (Exception e) {}
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try {
            ...
            String query = "delete from Pesanan where ID_Pesanan = '"+pesananText.getText()+"'";
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (newData == true && editData == false) {
            ...
            Connection();
            state = con.createStatement();
            String query = "insert into Pesanan values('"+pesananText.getText()+"', '"+keranjangText.getText()+"','"+adminText.getText()+"','"+waktuText.getText()+"','"+totalText.getText()+"','"+ongkosText.getText()+"','"+statusText.getText()+"')";
            state.executeUpdate(query);
            Display();
            state.close();
            con.close();
            ...
            Connection();
            state = con.createStatement();
            String query = "update Pesanan set ID_Pesanan = '"+pesananText.getText()+"', Keranjang_ID_Keranjang = '"+keranjangText.getText()+"', Karyawan_Admin_ID_Admin = '"+adminText.getText()+"', Waktu_Pemesanan = '"+waktuText.getText()+"', Total_Harga = '"+totalText.getText()+"', Ongkos_Kirim = '"+ongkosText.getText()+"', Status_Pemesanan = '"+statusText.getText()+"' where ID_Pesanan= '"+pesananText.getText()+"'";
            state.executeUpdate(query);
            Display();
            state.close();
            con.close();
    ...
    private void keranjangTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keranjangTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_keranjangTextActionPerformed
    ...
    private void ongkosTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ongkosTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ongkosTextActionPerformed
    ...
    private void searchTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTextKeyReleased
        ...
        try {
            Connection();
            state = con.createStatement();
            String query = "select * from Pesanan where ID_Pesanan like '%"+searchText.getText()+"%' or Keranjang_ID_Keranjang like '%"+searchText.getText()+"%' or Karyawan_Admin_ID_Admin like '%"+searchText.getText()+"%' or Waktu_Pemesanan like '%"+searchText.getText()+"%' or Total_Harga like '%"+searchText.getText()+"%' or Ongkos_Kirim like '%"+searchText.getText()+"%' or Status_Pemesanan like '%"+searchText.getText()+"%'";
    ...
    private javax.swing.JTextField keranjangText;
    private javax.swing.JButton lastButton;
    private javax.swing.JButton newButton;
    private javax.swing.JButton nextButton;
    private javax.swing.JTextField ongkosText;
